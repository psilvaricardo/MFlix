...
public class BasicReads extends AbstractLesson {
  ...
  public void testCanFindOne() {
    ...
    MongoCursor cursor = moviesCollection.find(new Document())
            .limit(1)
            .iterator();
  ...
  public void testFindOneSalmaHayek() {
    ...
    Document actual = moviesCollection.find(queryFilter)
            .limit(1)
            .iterator()
            .next();
  ...
  public void testNoNext() {
    ...
    moviesCollection.find(new Document("title", "foobarbizzlebazzle"))
            .iterator()
            .next();
  }
